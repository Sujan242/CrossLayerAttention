...
class Config:
    def __init__(self, n_digits, data_dir: str, n_train: int, n_val: int, n_test: int, resample_data: bool, seed: int):
...
def generate_addition_data(config) -> None:
